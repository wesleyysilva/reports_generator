defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when a file list is provided, returns an error" do
  ...
  describe "fetch_higher_cost/2" do
    test "when the option in 'users', returns the user who spent the most" do
      file_name = "report_test.csv"
    ...
    test "when the option in 'food', returns the most consumed food" do
      file_name = "report_test.csv"
